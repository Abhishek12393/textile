									...
									<table id="basicExample" class="table custom-table">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $u->mobile_phone; ?></td>
												<td><?php echo $u->city; ?></td>
												<td class="td-actions">
													<a href="<?php echo site_url("users/edit/").$u->id; ?>" class="icon green" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Row">
