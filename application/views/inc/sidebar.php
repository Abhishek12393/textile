<nav id="sidebar" class="sidebar-wrapper">
				...
				<div class="sidebar-brand">
					<a href="index.html" class="logo">
						<img src="<?php echo base_url('assets/'); ?>img/logo.png" alt="Le Rouge Admin Dashboard" />
					</a>
				</div>
				<!-- Sidebar brand end  -->
						...
						<ul>
							...
							<li class="sidebar-dropdown">
								<a href="#">
									...
									<span class="menu-text">Office Setup</span>
								</a>
								<div class="sidebar-submenu">
									<ul>
										<li><a href="<?php echo site_url("office_setup/rdo");?>">RDO</a></li>
										<li><a href="<?php echo site_url("office_setup/ado");?>">Assistant Director Office</a></li>
										<li><a href="<?php echo site_url("office_setup/rwa");?>">Ad Working Area</a></li>
										
									</ul>
								</div>
							</li>
							<li>
								<a href="<?php echo site_url("office_setup/crafts");?>">
									<i class="icon-phone1"></i>
									<span class="menu-text">Craft Name</span>
								</a>
							</li>
							<li>
								<a href="<?php echo site_url("office_setup/bank_name");?>">
									<i class="icon-documents"></i>
									<span class="menu-text">Bank Name Listing</span>
								</a>
							</li>
							<li class="sidebar-dropdown">
								<a href="#">
								...
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="<?php echo site_url("letters/letter_listing");?>">Letter listings</a>
										</li>
										<li>
							...
							<li>
								<a href="<?php echo site_url("cards/addCard");?>">
									<i class="icon-documents"></i>
							...
							<li>
								<a href="#">
									...
									<span class="menu-text">Id Card Uploaded</span>
								</a>
							</li>
							<li>
								<a href="#">
									<i class="icon-documents"></i>
									<span class="menu-text">Data Entry Listings</span>
								</a>
							</li>
							<li>
								<a href="#">
									<i class="icon-documents"></i>
									<span class="menu-text"> Un-Verified ID Cards </span>
								</a>
							</li>
							<li>
								<a href="#">
									<i class="icon-documents"></i>
									<span class="menu-text"> Verified ID Cards </span>
								</a>
							</li>
							<li>
								<a href="#">
									<i class="icon-documents"></i>
									<span class="menu-text"> Rejected ID Cards  </span>
								</a>
							</li>
							<li>
								<a href="#">
									<i class="icon-documents"></i>
									<span class="menu-text"> Restore Rejected ID Cards  </span>
								</a>
							</li>
							<li>
								<a href="#">
									<i class="icon-documents"></i>
									<span class="menu-text"> Release Un-submitted Form  </span>
								</a>
							</li>
							<li>
								<a href="#">
									<i class="icon-documents"></i>
									<span class="menu-text"> Release Verification Form   </span>
								</a>
							</li>
							...
							<li class="sidebar-dropdown">
								<a href="#">
									<i class="icon-layout"></i>
									<span class="menu-text">Report Data Entry & Verification</span>
								</a>
								<div class="sidebar-submenu">
									<ul>
										<li>
											<a href="#">Detail Entry Report</a>
										</li>
										<li>
											<a href="#">All Staff Data Entry Report </a>
										</li>
										<li>
											<a href="#">Search Data Entry Report </a>
										</li>
									</ul>
								</div>
							</li>
