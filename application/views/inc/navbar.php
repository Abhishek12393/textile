				...
				<li class="dropdown">
					<a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
						<span class="user-name">
							<?php #echo $this->session->userdata['admin_in']['first_name'].' '.$this->session->userdata['admin_in']['last_name']; ?>
						</span>
						<span class="avatar">
						...
						<div class="header-profile-actions">
							<div class="header-user-profile">
								<div class="header-user">
									<img src="<?php echo base_url('assets/'); ?>img/user.png" alt="Admin Template">
								</div>
								<h5><?php #echo $this->session->userdata['admin_in']['first_name'].' '.$this->session->userdata['admin_in']['last_name']; ?></h5>
								<p>##</p>
							</div>
							<a href="<?php echo site_url("auth/logout"); ?>"><i class="icon-log-out1"></i> Sign Out</a>
						</div>
					</div>
				</li>
			</ul>						
