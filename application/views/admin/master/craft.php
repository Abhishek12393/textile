			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Crafts</li>
					</ol>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="custom-actions-btns mb-5">
								...
								<a href="./rwa/add_rwa" class="btn btn-success">
									<i class="icon-add"></i> Add New Craft
								</a>
							</div>
						</div>
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="table-responsive">
									<table id="basicExample" class="table custom-table">
										...
										<tbody>
											...
											<tr>
                      <td><?php echo $m->cc_desc; ?></td>
											<td><?php echo $m->cc_name == '' ?'--': $m->cc_name;  ?></td> 
											<td><?php echo $m->is_active == 1 ? 'Active' : ''; ?></td> <!-- -->
										 
											<td><?php echo $m->created; ?></td>
											<td class="td-actions">
													<a href="<?php echo site_url("craft/edit/").$m->id; ?>" class="icon green" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Row">
