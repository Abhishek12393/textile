			...
			<div class="page-content">
				...
				<div class="page-header">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">RWA</li>
					</ol>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="custom-actions-btns mb-5">
								...
								<a href="./rwa/add_rwa" class="btn btn-success">
									<i class="icon-add"></i> Add AD Working Area
								</a>
							</div>
						</div>
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="table-container">
								<div class="t-header">AD Working Area</div>
								<div class="table-responsive">
									<table id="basicExample" class="table custom-table">
										<thead>
											<tr>
												<th>Regional Office Code</th>
												<th>Asst Director Office / code</th>
												<th>AD Working Area</th>
												<th>Added Date</th>
												<th>Action</th>
											</tr>
										</thead>
										<tbody>
											...
											<tr>
											<td><?php echo $m->rc; //need to join rdo with this ?></td> 
											<td><?php echo $m->city.' / '.$m->city_code; ?></td>
											<td><?php echo $m->title; ?></td> <!-- ad working area -->
